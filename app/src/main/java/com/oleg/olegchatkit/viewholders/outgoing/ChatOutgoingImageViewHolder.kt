...
class ChatOutgoingImageViewHolder(itemView: View) : BaseViewHolder<Chat>(itemView) {

    private val ivPictureMessage: ImageView = itemView.findViewById(R.id.iv_chat_outgoing_image)
