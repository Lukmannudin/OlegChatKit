...
class ChatIncomingTextViewHolder(itemView: View) : BaseViewHolder<Chat>(itemView) {

    private val tvChatMessage: TextView = itemView.findViewById(R.id.tv_chat_incoming_message)
